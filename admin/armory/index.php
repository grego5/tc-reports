...
<html>
	...
	<meta http-equiv="Content-Type" content="text/html;charset=UTF-8" />
        <style>
            ...
            a {-webkit-transition: all 0.2s ease; -moz-transition: all 0.2s ease; -o-transition: all 0.2s ease; transition: all 0.2s ease; color: #e4f1fb; text-decoration: none}
            a:hover {color: #aed0ea;}
            #site-body{width: 600px; margin:0 auto; font-family: Optima, Segoe, "Segoe UI", Candara, Calibri, Arial, sans-serif; position: relative;}
            #report {margin:0 auto 200px auto; border-collapse: collapse; table-layout:fixed; width: 100%; box-shadow: -0px 0px 10px #5a5a5a;}
            thead, tfoot {background-color: #2d2d2d; color: #e4f1fb}
            th, td {padding: 2px 5px; width: 55px; overflow: hidden; text-overflow: ellipsis}
            tbody tr {text-align: center}
            tbody td:first-child {font-weight: 600; width: 140px; text-align: left}
            tbody tr:nth-child(odd) {background: #e6e6e6}
            tbody tr:nth-child(even) {background: #fcfcfc}
            tbody tr:hover {background: #99ccff}
        </style>
    </head>
    <body>
        <div id="site-body">
